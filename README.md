...
## 프로젝트 배경
기존에는 카카오톡 단체 채팅방에서 장소(연습실) 예약을 관리했습니다. 예약이 늘어날수록 불편함이 커졌습니다.

- 원하는 시간대가 이미 예약되어 있는지 확인하려면 이전 대화를 직접 찾아봐야 했음
- 예약 시간이 겹치는지 바로 확인하기 어려웠음
- 전체 예약 현황을 한눈에 파악하기 힘들었음

이를 해소하기 위해 외부 예약 앱을 도입했지만, 새로운 문제가 생겼습니다.

- 구글 캘린더와 연동이 되지 않아 관리자가 예약 현황을 수동으로 옮겨 적어야 했음
- 모바일 화면에 최적화되지 않아 조작이 불편했음

두 문제를 모두 해결하기 위해 직접 개발을 시작했습니다.
