CREATE TYPE "public"."sync_run_status" AS ENUM('success', 'partial', 'failed');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "calendar_sync_items" ADD CONSTRAINT "calendar_sync_items_run_id_calendar_sync_runs_id_fk" FOREIGN KEY ("run_id") REFERENCES "public"."calendar_sync_runs"("id") ON DELETE cascade ON UPDATE no action;
