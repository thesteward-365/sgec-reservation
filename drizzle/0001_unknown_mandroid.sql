...
--> statement-breakpoint
INSERT INTO `__new_reservation_histories`("id", "reservation_id", "actor_user_id", "actor_user_name", "action_type", "changes", "created_at") SELECT "id", "reservation_id", "actor_user_id", "actor_user_name", "action_type", "changes", "created_at" FROM `reservation_histories`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_reservations`("id", "user_id", "place_id", "start_time", "end_time", "purpose", "google_event_id", "created_at") SELECT "id", "user_id", "place_id", "start_time", "end_time", "purpose", "google_event_id", "created_at" FROM `reservations`;--> statement-breakpoint
...
ALTER TABLE `calendar_settings` ADD `event_calendar_id` text;--> statement-breakpoint
ALTER TABLE `calendar_settings` ADD `connected_email` text;