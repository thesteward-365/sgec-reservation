    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <main className="flex-1 overflow-auto">
        <style
          ...
          #output-content > ol { padding-left: 35px; }
          #output-content > ul { padding-left: 35px; }
          ul { margin: 0px; padding-left: 25px; text-indent: 0px; }
          ul > li { font-weight: normal; }
          ol { margin: 0px; padding-left: 25px; text-indent: 0px; }
          ol > li { font-weight: normal; }
          #output-content > ol > li {list-style-type: decimal;font-size: 14px;}
          #output-content > table > tbody > tr > td > ol > li {list-style-type: decimal;font-size: 14px;}
          #output-content > ol > li > table > tbody > tr > td > ol > li {list-style-type: decimal;font-size: 14px;}
          #output-content > ol > li > ol > li {list-style-type: hangul;font-size: 14px;}
          #output-content > table > tbody > tr > td > ol > li > ol > li {list-style-type: hangul;font-size: 14px;}
          #output-content > ol > li > table > tbody > tr > td > ol > li > ol > li {list-style-type: hangul;font-size: 14px;}
          /* Basic list numbering styles */
        ...
        <div
          ...
          dangerouslySetInnerHTML={{
            ...
            <br>
            <p class="provision_title"><strong>제2조(개인정보 처리의 원칙)</strong></p>
            ...
            <br>
            <p class="provision_title"><strong>제3조(본 방침의 공개)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제4조(본 방침의 변경)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제5조(회원 가입을 위한 정보)</strong></p>
            <p>회사는 이용자의 회사 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다.</p>
            <ol>
              <li>필수 수집 정보: <strong>비밀번호, 이름 및 휴대폰 번호</strong></li>
            </ol>
            <br>
            <p class="provision_title"><strong>제6조(개인정보 수집 방법)</strong></p>
            ...
            <ol>
              ...
              <li><strong>이용자가 회원가입 시 개인정보를 직접 입력하는 방식</strong></li>
            </ol>
            <br>
            <p class="provision_title"><strong>제7조(개인정보의 이용)</strong></p>
            ...
            <br>
            <p class="provision_title"><strong>제8조(개인정보의 보유 및 이용기간)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제9조(법령에 따른 개인정보의 보유 및 이용기간)</strong></p>
            ...
            <br>
            <p class="provision_title"><strong>제10조(개인정보의 파기원칙)</strong></p>
            <p>회사는 원칙적으로 이용자의 개인정보 처리 목적의 달성, 보유·이용기간의 경과 등 개인정보가 필요하지 않을 경우에는 해당 정보를 지체 없이 파기합니다.</p>
            <br>
            <p class="provision_title"><strong>제11조(개인정보파기절차)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제12조(개인정보파기방법)</strong></p>
            <p>회사는 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제하며, 종이로 출력된 개인정보는 분쇄기로 분쇄하거나 소각 등을 통하여 파기합니다.</p>
            <br>
            <p class="provision_title"><strong>제13조(광고성 정보의 전송 조치)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제14조(아동의 개인정보보호)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제15조(개인정보 조회 및 수집동의 철회)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제16조(개인정보 정보변경 등)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제17조(이용자의 의무)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제18조(회사의 개인정보 관리)</strong></p>
            <p>회사는 이용자의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 유출, 변조, 훼손 등이 되지 아니하도록 안전성을 확보하기 위하여 필요한 기술적·관리적 보호대책을 강구하고 있습니다.</p>
            <br>
            <p class="provision_title"><strong>제19조(삭제된 정보의 처리)</strong></p>
            ...
            <br>
            <p class="provision_title"><strong>제20조(비밀번호의 암호화)</strong></p>
            <p>이용자의 비밀번호는 일방향 암호화하여 저장 및 관리되고 있으며, 개인정보의 확인, 변경은 비밀번호를 알고 있는 본인에 의해서만 가능합니다.</p>
            <br>
            <p class="provision_title"><strong>제21조(해킹 등에 대비한 대책)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제22조(개인정보 처리 최소화 및 교육)</strong></p>
            <p>회사는 개인정보 관련 처리 담당자를 최소한으로 제한하며, 개인정보 처리자에 대한 교육 등 관리적 조치를 통해 법령 및 내부방침 등의 준수를 강조하고 있습니다.</p>
            <br>
            <p class="provision_title"><strong>제23조(개인정보 유출 등에 대한 조치)</strong></p>
            ...
            <br>
            <p class="provision_title"><strong>제24조(개인정보 유출 등에 대한 조치의 예외)</strong></p>
            <p>회사는 전조에도 불구하고 이용자의 연락처를 알 수 없는 등 정당한 사유가 있는 경우에는 회사의 홈페이지에 30일 이상 게시하는 방법으로 전조의 통지를 갈음하는 조치를 취할 수 있습니다.</p>
            <br>
            <p class="provision_title"><strong>제25조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</strong></p>
            <ol>
            ...
            <br>
            <p class="provision_title"><strong>제26조(쿠키 설치 허용 지정 방법)</strong></p>
            ...
            <br>
            <p class="provision_title"><strong>제28조(권익침해에 대한 구제방법)</strong></p>
            <ol>
