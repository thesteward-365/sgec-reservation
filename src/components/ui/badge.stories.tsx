  ...
  render: () => (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap gap-2 items-center">
        <Badge variant="solid" color="blue">신규</Badge>
        <Badge variant="solid" color="green">승인</Badge>
        <Badge variant="solid" color="red">취소</Badge>
        <Badge variant="solid" color="orange">대기</Badge>
...
export const Subtle: Story = {
  render: () => (
    <div className="flex flex-wrap gap-2 items-center">
      <Badge variant="subtle" color="blue">예약확정</Badge>
      <Badge variant="subtle" color="green">승인완료</Badge>
      <Badge variant="subtle" color="red">예약취소</Badge>
      <Badge variant="subtle" color="orange">승인대기</Badge>
      <Badge variant="subtle" color="violet">공지</Badge>
    </div>
  ),
}
